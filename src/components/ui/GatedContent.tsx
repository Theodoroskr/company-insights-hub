  ...
  return (
    <div className="relative rounded-lg overflow-hidden">
      ...
      >
        ...
        <p
          className="text-sm font-medium text-center max-w-xs px-4"
        ...
        {ctaLabel && onCta && (
          <button
            onClick={onCta}
            className="mt-1 px-4 py-2 rounded text-sm font-semibold text-white transition-all active:scale-95"
            style={{
